...
public sealed partial class AnomalySystem
{
    ...
    {
        var rating = args.GetRating(component.MachinePartPointMultiplier);

        component.PointMultiplier = component.BasePointMultiplier * (component.UpgradePointMultiplier * rating);

        if (TryComp<RadiationSourceComponent>(uid, out var radiation))
            radiation.Intensity = component.BaseRadiation * (component.UpgradeRadiationMultiplier * rating);
    }
