...
public sealed partial class PlayerConnectionWhitelistPrototype : IPrototype
{
    ...
    /// </summary>
    [DataField]
    public int MinimumPlayers { get; private set; } = 0;
    ...
    /// </summary>
    [DataField]
    public int MaximumPlayers { get; private set; } = int.MaxValue;

    [DataField]
    public WhitelistCondition[] Conditions { get; private set; } = default!;
}
