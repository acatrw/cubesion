...
namespace Content.Client.Lobby.UI
{
    ...
    public sealed partial class CharacterSetupGui : Control
    {
            ...
            HumanoidProfileEditor profileEditor)
        {
            ...
            // Eclipsion - solid gunmetal instead of a see-through brown, so faction banners and text don't
            //   have the lobby art showing through them.
            var panelTex = resourceCache.GetTexture("/Textures/_Crescent/Interface/Eclipsion/Nano/button.png");
            var back = new StyleBoxTexture
            {
                Texture = panelTex,
                Modulate = StyleNano.OnButtonTexture(StyleNano.EclipsionPanel).WithAlpha(0.96f)
            };
