...
lobby-character-preview-panel-previous-character-tooltip = Previous character: {$name}
lobby-character-preview-panel-next-character-tooltip = Next character: {$name}
