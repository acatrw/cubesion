...
signal-port-name-passport-scan-receiver = Passport reader
signal-port-description-passport-scan-receiver = Receives passport data for identity verification.

signal-port-name-fingerprint-scan-receiver = Fingerprint reader
signal-port-description-fingerprint-scan-receiver = Receives a live fingerprint scan for identity verification.
