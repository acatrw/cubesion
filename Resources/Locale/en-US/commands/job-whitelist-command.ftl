cmd-jobwhitelist-job-does-not-exist = Job or whitelist group {$job} does not exist.
cmd-jobwhitelist-player-not-found = Player {$player} not found.
cmd-jobwhitelist-hint-player = [player]
cmd-jobwhitelist-hint-job = [job or whitelist group]
cmd-jobwhitelistadd-desc = Lets a player play a whitelisted job, or every job in a whitelist group.
cmd-jobwhitelistadd-help = Usage: jobwhitelistadd <username> <job or whitelist group>
...
cmd-jobwhitelistremove-desc = Removes a player's ability to play a whitelisted job, or every job in a whitelist group.
cmd-jobwhitelistremove-help = Usage: jobwhitelistremove <username> <job or whitelist group>
