...
ghost-gui-insurance-respawn-ready = Insurance respawn
ghost-gui-insurance-respawn-timer = Insurance respawn ({$time})
ghost-gui-insurance-respawn-no-machine = No cloning machine linked
ghost-gui-insurance-respawn-no-power = Cloning machine unpowered
